...
func (round *round5) Start() *gg20.Error {
	if round.started {
	...
	modN := utils.ModInt(gg20.EC().Params().N)
	...
	for j, Pj := range round.Parties().IDs() {
		...
		bigGammaJPoint, err := crypto.NewECPoint(gg20.EC(), bigGammaJ[0], bigGammaJ[1])
		if err != nil {
...
func (round *round5) Update() (bool, *gg20.Error) {
...
func (round *round5) CanAccept(msg gg20.ParsedMessage) bool {
...
func (round *round5) NextRound() gg20.Round {
	round.started = false
